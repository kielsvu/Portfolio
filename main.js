...
var APPS = [
  ...
  {name:"Bun",       svg:'<svg viewBox="0 0 24 24"><rect width="24" height="24" rx="12" fill="#fbf0df"/><ellipse cx="12" cy="13" rx="7" ry="6" fill="#f6dece"/><ellipse cx="12" cy="13" rx="7" ry="6" fill="none" stroke="#c8956c" stroke-width=".8"/><ellipse cx="9" cy="11" rx="1.2" ry="1.4" fill="#2d1b00"/><ellipse cx="15" cy="11" rx="1.2" ry="1.4" fill="#2d1b00"/><path d="M9.5 14.5c.6.8 1.4 1.2 2.5 1.2s1.9-.4 2.5-1.2" stroke="#c8956c" stroke-width=".9" fill="none" stroke-linecap="round"/></svg>'},
  {name:"Vite",      svg:'<svg viewBox="0 0 24 24"><path fill="#646cff" d="M21.5 3L13 20.5l-1.5-8.5L3 9l18.5-6z"/><path fill="#bd34fe" d="M13 20.5L4 5.5l9 6L13 20.5z"/></svg>'}
];
